...
* CompuLab
```
wget --directory-prefix .repo/local_manifests https://raw.githubusercontent.com/compulab-yokneam/meta-bsp-imx8mp/ucm-imx8m-plus-sbev-r1.0/scripts/meta-bsp-imx8mp.xml
```
...
Use [Get the product DRAM configuration ](https://github.com/compulab-yokneam/meta-bsp-imx8mp/blob/ucm-imx8m-plus-sbev-r1.0/Documentation/dram.md) for more details
