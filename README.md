...
* CompuLab
```
wget --directory-prefix .repo/local_manifests https://raw.githubusercontent.com/compulab-yokneam/meta-bsp-imx8mp/scarthgap-d1d8_d2d4/scripts/meta-bsp-imx8mp.xml
```
...
Use [Get the product DRAM configuration ](https://github.com/compulab-yokneam/meta-bsp-imx8mp/blob/scarthgap-d1d8_d2d4/Documentation/dram.md) for more details
